...
int main()
{
    ...
    //se declara la variable i para el ciclo for, se inicializa en 2 ya que los primeros terminos ( 0 y 1 ) no se debenn iterar, se evalua si i es menor que cantidadDeTerminos+1 y se incrementa en 1
    for( int i = 2; i <= cantidadDeTerminos + 1; i++ )
    {
