...
int VerificarResultados( int numero, int *mayor, int *menor, int *negativos, int *positivos, int *sumaPositivos, int *mayores150 )
...
{   
    ...
    for( int contador=0; contador < 15; contador++ )
    {
        ...
        VerificarResultados( numero, &numeroMayor, &numeroMenor, &negativos, &positivos, &sumaPositivos, &mayores150 );
    }//fin del for

    //se declaran las variables sumaPositivosFloat y positivosFloat de tipo flotante porque que el resultado de la división puede ser un número decimal
