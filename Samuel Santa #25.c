...
int main()
{
    int fila=1, espacios=9, Z=1;//se declaran las variables fila, espacios y Z, fila para el ciclo for, espacios para la cantidad de espacios que se van a imprimir al inicio de cada columna y Z para la cantidad de letras Z que se van a imprimir en cada fila
